...
hi TabLine      ctermfg=fg  guifg=fg      ctermbg=0 guibg=#666666 cterm=none gui=none
hi TabLineFill  ctermfg=fg  guifg=fg      ctermbg=0 guibg=#3a3a3a cterm=none gui=none
" FIXME
